// .obj viewer
// uses Phong-Blinn shading model for specular reflection
...
var vertex_obj = `#version 300 es
    ...
    void main() {
        ...
        v_normal = normalize(vec3(u_normal_mat * a_normal)); // pass normal to frag

        v_color = a_color; // pass material color to frag shader
...
var frag_obj = `#version 300 es
    ...
    void main() {
        ...
        vec3 eye_position = vec3(0.0, 20.0, 40.0); // camera pos
        ...
        vec3 halfway = normalize((light_dir + eye_dir) / 2.0);
...
function main () {
    ...
    gl.program.u_normal_mat = gl.getUniformLocation(gl.program, 'u_normal_mat');
...
function draw_obj (vp_mat) {
    ...
    gl.uniformMatrix4fv(gl.program.u_normal_mat, false, g_normal_mat.elements);
    ...
    gl.uniformMatrix4fv(gl.program.u_model_mat, false, g_model_mat.elements);
