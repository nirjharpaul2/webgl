// .obj viewer
// switch between two different shader programs

var vertex_gouraud = `#version 300 es
...
var frag_gouraud = `#version 300 es
    ...
    void main() {
        if (u_is_texture) {
            ...
            cs_FragColor = vec4(c, 1.0);
        }
        else cs_FragColor = v_color;   
    }
`;
...
let url = url_prefix + "buddha2.obj";
